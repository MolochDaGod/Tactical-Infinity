/**
   * Rolling Hills — vendored Shadertoy fragment shader.
   *
   * Original: David Hoskins, November 2013 — https://www.shadertoy.com/view/Xsf3zX
   ...
   */
  export const ROLLING_HILLS_FRAG = `
