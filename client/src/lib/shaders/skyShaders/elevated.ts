/**
   * Elevated Mountains — vendored Shadertoy fragment shader.
   *
   * Original: Inigo Quilez (iq), 2013 — https://www.shadertoy.com/view/MdX3Rr
   * License : CC BY-NC-SA 3.0
   *
   * Adapted for Three.js ShaderMaterial use:
   *   • TONE_MAPPING #if blocks stripped (referenced undefined helper).
   *   • Expects uniforms iResolution(vec3 = w,h,aspect), iGlobalTime(float),
   *     iMouse(vec2), iChannel0(sampler2D), iChannel2(sampler2D) and varying vUv.
   *   • Fullscreen — render on a clip-space plane behind the scene.
   *
   * Auto-generated by scripts/build-sky-shaders (one-shot). Do not hand-edit.
   */
  export const ELEVATED_FRAG = `
