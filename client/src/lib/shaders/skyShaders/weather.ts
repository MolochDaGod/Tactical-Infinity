/**
   * Weather (sea + clouds + rain + lightning) — vendored Shadertoy fragment shader.
   *
   * Original: David Hoskins, May 2014 — https://www.shadertoy.com/view/4dsXWn
   ...
   *     iMouse(vec2), iChannel0(sampler2D) and varying vUv.
