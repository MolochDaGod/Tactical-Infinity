...
export const PAGE_REGISTRY: PageMeta[] = [
  ...
  { phase: "dockworkshop",    slug: "/dock-workshop",       title: "Boat Dock Workshop",          description: "Boatbuilder scene · deck XYZ · marine AI · ?tester=1",      category: "overworld", publicNav: true },
